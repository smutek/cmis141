...
public class HomeworkOneReadWrite {
   ...
   * with the following conversions and calculations: Displays letter grade for each percentage
   * Converts age from months to years Converts and prints temperature in degrees F
   *
   * @param args String[].
   */
